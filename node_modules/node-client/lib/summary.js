...
module.exports = (name, labelNames = [], percentiles = [0.9, 0.99]) => new Summary(name, labelNames, percentiles);
...
class Summary {
     ...
     * @param {Array.<double>} Configurable percentiles, values should never be greater than 1
     */
    constructor(name, labelNames, percentiles) {
        if (monitor.isEnable) {
